...
export function EmptyPlanState() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 24, textAlign: 'center' }}>
      ...
      <h3 style={{ fontSize: 16, color: 'var(--ink-900)', margin: '0 0 4px' }}>No floorplan yet</h3>
      <p style={{ fontSize: 13, color: 'var(--ink-600)', margin: 0, maxWidth: 320 }}>
        Upload a rendered plan for {floor?.name ?? 'this floor'} to start mapping rooms, desks, lockers, and parking stalls.
      </p>
